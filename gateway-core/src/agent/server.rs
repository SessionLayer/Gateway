...
/// The ingress-side peer-relay dependencies. Shared with the
...
fn server_config(
    ...
    // Client certificate REQUIRED: neither role is reachable without the agent identity.
    ...
    S: tokio::io::AsyncRead + tokio::io::AsyncWrite + Unpin,
{
    ...
    // approaches the interval is not flapped offline.
